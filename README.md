...
Focuses on improving developer output and efficiency with OpenShift's Application Platform capabilities. Attendees get hands-on experience with Dev Spaces with Agentic AI, GitOps, Pipelines, Developer Hub, Red Hat Application Foundations, and more.

**Owner:** evanshortiss
**Migrated from:** https://github.com/rhpds/ocp-dev-days-rdshw-showroom
...
1. Open in DevSpaces: `https://devspaces.apps.ocpv-infra02.wdc07.infra.demo.redhat.com#https://github.com/rhpds/dev-day-roadshow`
...
2. Clone the repo:
   ```
   git clone https://github.com/rhpds/dev-day-roadshow
   ```
3. `cd dev-day-roadshow`
